...
Code is formatted with [Black](https://github.com/psf/black) (line length 120) and imports are sorted with [isort](https://github.com/PyCQA/isort) (Black profile). Install the dev dependencies with:

```bash
pip install -e ".[dev]"
```

Then format the code with:
